...
versioned_symbol (libc, __pthread_attr_setscope,
		  pthread_attr_setscope, GLIBC_2_2);

compat_symbol (libpthread, __pthread_attr_setscope,
	       pthread_attr_setscope, GLIBC_2_0);

...
versioned_symbol (libc, __pthread_condattr_init,
		  pthread_condattr_init, GLIBC_2_2);

compat_symbol (libpthread, __pthread_condattr_init,
	       pthread_condattr_init, GLIBC_2_0);

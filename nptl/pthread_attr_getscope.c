...
versioned_symbol (libc, __pthread_attr_getscope,
		  pthread_attr_getscope, GLIBC_2_2);

compat_symbol (libpthread, __pthread_attr_getscope,
	       pthread_attr_getscope, GLIBC_2_0);

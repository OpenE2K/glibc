...
versioned_symbol (libc, __pthread_attr_setdetachstate,
		  pthread_attr_setdetachstate, GLIBC_2_2);

compat_symbol (libpthread, __pthread_attr_setdetachstate,
	       pthread_attr_setdetachstate, GLIBC_2_0);

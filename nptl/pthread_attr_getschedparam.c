...
versioned_symbol (libc, __pthread_attr_getschedparam,
		  pthread_attr_getschedparam, GLIBC_2_2);

compat_symbol (libpthread, __pthread_attr_getschedparam,
	       pthread_attr_getschedparam, GLIBC_2_0);

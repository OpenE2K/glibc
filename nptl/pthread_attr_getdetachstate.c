...
versioned_symbol (libc, __pthread_attr_getdetachstate,
		  pthread_attr_getdetachstate, GLIBC_2_2);

compat_symbol (libpthread, __pthread_attr_getdetachstate,
	       pthread_attr_getdetachstate, GLIBC_2_0);

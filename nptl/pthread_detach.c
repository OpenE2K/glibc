...
/* No pthread_detach@... actually existed in libc-2.29.so, but we need
   pthread_detach@GLIBC_2.0 with exactly the same version it had in
   ...
   that above?  */
weak_alias (___pthread_detach, ___pthread_detach_weak)
compat_symbol (libpthread, ___pthread_detach_weak, pthread_detach, GLIBC_2_0);

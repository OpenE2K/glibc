...
versioned_symbol (libc, __pthread_attr_setinheritsched,
		  pthread_attr_setinheritsched, GLIBC_2_2);

compat_symbol (libpthread, __pthread_attr_setinheritsched,
	       pthread_attr_setinheritsched, GLIBC_2_0);

...
versioned_symbol (libc, __pthread_getschedparam,
		  pthread_getschedparam, GLIBC_2_2);

compat_symbol (libpthread, __pthread_getschedparam,
	       pthread_getschedparam, GLIBC_2_0);

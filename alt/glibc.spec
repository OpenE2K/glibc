...
%ifarch %e2k
%add_optflags -O3 -D__OPTIMIZE__ -fasm-entries-first -fno-strict-aliasing -fno-ipa-attrs -mptr64 -U__NO_INLINE__ -masm-inline -Wno-builtin-functions-redefined -Wno-builtin-declaration-mismatch -Wno-error=invalid-builtin-arg -Wno-error=maybe-uninitialized
%endif
...
%ifarch %e2k
	--build=e2k-alt-linux \
	--host=e2k-alt-linux \
	--enable-extra-optimizations="%optflags" \
%else
...
%changelog
* Wed May 19 2021 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.014.1
- Update to MCST version 2.29-25.014.
- Upstream, fedora and sisyphus are already up-to-date.

* Wed Apr 21 2021 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.011.3
...
* Fri Mar 12 2021 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.011.2
...
* Thu Jan 21 2021 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.011.1
- Update to MCST version 2.29-25.011.
- Sync spec with sisyphus 2.32-alt2.
- Sync with upstream, commit 1864775abc7301a0387fb137b622ee6d6d7f2fbd.
- Fixed: CVE-2020-29562
  Note: this CVE fixed half a year ago, but it wasn't announced back than.

* Tue Dec 15 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.010.1
- Update to MCST version 2.29-25.010.
- Sync spec with sisyphus 2.30-alt3.

* Tue Nov 10 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.007.1
- Update to MCST version 2.29-25.007.

* Tue Oct 06 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.006_1
- Update to MCST version 2.29-25.006.

* Mon Sep 14 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.005_1
- Update to MCST version 2.29-25.005.

* Wed Jul 29 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt2.E2K.25.003_1
- Update to MCST version 2.29-25.003.
- Sync with upstream 2.29 branch.

* Tue Jun 16 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt1.E2K.4
- Update to MCST version 2.29-24.016.
- Synch with glibc-2.30-alt2:
  - Moved %_bindir/locale from %name-locales to %name-core.
  - Moved %_bindir/localedef from %name-locales to %name-utils.

* Fri May 15 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt1.E2K.3
- Revert bootstrap changes to re-enable fully functional glibc.
  This fixes missing __signbitf128 symbol.

* Thu Apr 23 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt1.E2K.2
- Build mo files and improve manual generation.

* Wed Apr 22 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt1.E2K.1
- Debootstrap AutoReq check for perl.

* Mon Apr 20 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.29-alt1.E2K.0
- Update to MCST version 2.29-24.010.
- Synch with glibc upstream for 2.29 branch, commit a318448f7ac.
- Grab some Fedora patches for 2.29.
- Synch with Sisyphus glibc-2.30 (patches, spec).

* Thu Apr 02 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.18
- The password hashing library, libcrypt, is now provided
  by a separate package.

* Thu Apr 02 2020 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.17
- Move libcrypt from glibc-core to a separate subpackage as a part of the
  libcrypt separation.

* Thu Nov 29 2019 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.16
- Backport new condvar implementation from glibc-2.25 upstream.
  This fixes spurious mutex failure under rare conditions, see alt bug 37556.

* Thu Oct 03 2019 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.15
- Update to MCST 2.23-23.022 version: fix execstack enabled when it is
  requestedto be disabled, mcst bug 4370.

* Wed Sep 11 2019 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.14
- Update to MCST 2.23-23.021 version.

* Fri Jun 14 2019 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.13
- Add missing prlimit and prlimit64 declarations.

* Mon May 06 2019 Michael Shigorin <mike@altlinux.org> 6:2.23-alt3.E2K.12
- Drop non-ASCII chars in installed headers.

* Sat Dec 29 2018 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.11
- Update to MCST 2.23-23.017 version.
- Synch optflags with MCST's ones.

* Fri Nov 30 2018 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.10
- Update to MCST 2.23-23.010 branch for upcoming lcc-1.23 update.
- Use the same compiler flags as MCST to avoid SIGILL on printf (bug 3567).

* Mon Apr 09 2018 Gleb F-Malinovskiy <glebfm@altlinux.org> 6:2.23-alt3.E2K.9
- Fixed unresolved symbols in Scrt1.o (a part of C runtime for
  -pie executables).

* Tue Mar 27 2018 Grigory Ustinov <grenka@altlinux.org> 6:2.23-alt3.E2K.8.0.e2k.1
- NMU: Replace e2k arch name with %%e2k macro.

* Fri Jan 12 2018 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.8
- E2K: disable localedir to fix gettext problem (translations were missing);
  NB: it's upstream change in 2.24 backported to MCST's 2.23 too.

* Sat Jan 06 2018 Michael Shigorin <mike@altlinux.org> 6:2.23-alt3.E2K.7
- E2K: provide libcxx-devel (see also #34422).

* Fri Dec 29 2017 Andrew Savchenko <bircoph@altlinux.org> 6:2.23-alt3.E2K.6
- E2K: apply MCST glibc-2.23-21.023.tar on top of current branch.
- Apply upstream fixes for CVE-2017-{15670,15804}.
- Enable compiler atomics.

* Fri Aug 11 2017 Michael Shigorin <mike@altlinux.org> 6:2.23-alt3.E2K.5
- E2K: disable %%without optimization (won't build anyways); -O4
- try shifting *.info under bootstrap knob instead of e2k arch

* Tue Jan 10 2017 Michael Shigorin <mike@altlinux.org> 6:2.23-alt3.E2K.4
- BOOTSTRAP: cherrypick memusagestat knob from 2.24-alt1.

* Fri Jan 06 2017 Michael Shigorin <mike@altlinux.org> 6:2.23-alt3.E2K.3
- E2K: forget about %%renamed_locales for now.

* Fri Jan 06 2017 Michael Shigorin <mike@altlinux.org> 6:2.23-alt3.E2K.2
- E2K: actually re-added ALT patches, sigh.

* Sat Dec 31 2016 Michael Shigorin <mike@altlinux.org> 6:2.23-alt3.E2K.1
- E2K:
  + imported glibc-2.23-21.007.tar on top of glibc-2.23
  + BOOTSTRAP: disabled BR: libgd2-devel

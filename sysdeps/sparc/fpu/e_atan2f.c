/*
 * Copyright 11/21/00 Sun Microsystems, Inc.  All Rights Reserved.
 */
...
static const double __vlibm_TBL_atan1[] = {
        ...
        int             hy;
                ...
                if ( hx >= 0x7f800000 || hx - hy >= 0x0c800000 )
                {
                        if ( hx >= 0x7f800000 )
                        {
                                ...
                                ah0 = (double) y0 / x0;
                        return (float) (sign0 * ah0);
                }
                if ( hy < 0x00800000 )
                {
                        if (hy == 0) return (float) (sign0 * ah0);
                ...
                k0 = ( hy - hx + 0x3f800000 ) & 0xfff80000;

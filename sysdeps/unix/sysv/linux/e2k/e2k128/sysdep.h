...
/* These ones are of the same form both for new and old PM syscalls.  */
#define REG_PTR_TO_REG(src, dst) movtq src, dst
#define STACK_PTR_TO_REG(off, dst) ldapq %qr0, off, dst

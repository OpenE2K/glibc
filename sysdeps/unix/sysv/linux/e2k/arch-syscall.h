/* FIXME: manually copy/pasted from
   linux-mcst-trunk/arch/e2k/include/uapi/asm/unistd.h for now.
   TODO: find out how it could be AUTOGENERATED by update-syscall-lists.py.  */
...
#define __NR_reserved4		205
#define __NR_reserved5		206
...
/* free (unused) entries - reserve 403 - 419 */
...
#define __NR_mount_setattr		437
#define __NR_quotactl_fd		438
#define __NR_landlock_create_ruleset	439
#define __NR_landlock_add_rule		440
#define __NR_landlock_restrict_self	441
#define __NR_process_mrelease		442

#define	NR_syscalls		443

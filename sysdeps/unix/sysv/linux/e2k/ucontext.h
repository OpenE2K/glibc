...
/* Manipulate user context UCP to continue with calling functions FUNC
   ...
   At E2k this function may fail because it has to allocate HW stacks in
   addition to the one provided by the user. Therefore, it returns `int'
   instead of `void', which is why it's named in a non-standard way.  */
extern int makecontext_e2k (ucontext_t *__ucp, void (*__func) (void),
                            int __argc, ...) __THROW;

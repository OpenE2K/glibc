...
%  ëïíðìåëóîïçï  áòçõíåîôá.  îåäïðõóôéíùí  úîáþåîéåí     %
%  áòçõíåîôá  ñ÷ìñåôóñ  IM > 710.4758600739439771.       %
%                                                        %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
...
__csinf (__complex__ float x)
{
    ...
    /* ×ÙÞÉÓÌÅÎÉÅ si=sin(re) É co=cos(re) */
...
#pragma asm_inline
    ...
    /* ×ÙÞÉÓÌÅÎÉÅ exm=sinh(im) É exp=cosh(im) */

...
static const DB constcbrt_lo[] = {
    0.0000000000000000000e+00,  /* мл. ч. CBRT (1+ 0/32) */
    7.8579519600520049752e-07,  /* мл. ч. CBRT (1+ 1/32) */
    3.7673666123639144540e-07,  /* мл. ч. CBRT (1+ 2/32) */
    2.0373631889234437228e-07,  /* мл. ч. CBRT (1+ 3/32) */
    9.4167731924476502841e-07,  /* мл. ч. CBRT (1+ 4/32) */
    6.7839350818053832465e-07,  /* мл. ч. CBRT (1+ 5/32) */
    7.0349780532222453811e-07,  /* мл. ч. CBRT (1+ 6/32) */
    7.9865934248749693213e-07,  /* мл. ч. CBRT (1+ 7/32) */
    2.4296516061087964678e-07,  /* мл. ч. CBRT (1+ 8/32) */
    7.1964771938168058764e-07,  /* мл. ч. CBRT (1+ 9/32) */
    6.3458134731642995088e-07,  /* мл. ч. CBRT (1+10/32) */
    8.7439958844311291036e-07,  /* мл. ч. CBRT (1+11/32) */
    7.0309071823082681688e-08,  /* мл. ч. CBRT (1+12/32) */
    3.4893177164593687050e-07,  /* мл. ч. CBRT (1+13/32) */
    6.8241586362611126568e-07,  /* мл. ч. CBRT (1+14/32) */
    7.2636156644220048039e-07,  /* мл. ч. CBRT (1+15/32) */
    8.4075889827405804221e-07,  /* мл. ч. CBRT (1+16/32) */
    2.0155465070491867402e-07,  /* мл. ч. CBRT (1+17/32) */
    6.3247546034810251909e-07,  /* мл. ч. CBRT (1+18/32) */
    8.9851947898363500558e-07,  /* мл. ч. CBRT (1+19/32) */
    5.3477834749475000817e-07,  /* мл. ч. CBRT (1+20/32) */
    8.1297638901028126586e-07,  /* мл. ч. CBRT (1+21/32) */
    9.3851228241856377923e-07,  /* мл. ч. CBRT (1+22/32) */
    9.2221247333644000216e-07,  /* мл. ч. CBRT (1+23/32) */
    6.3648214624306418483e-07,  /* мл. ч. CBRT (1+24/32) */
    7.7799073155337094285e-07,  /* мл. ч. CBRT (1+25/32) */
    1.4926531456532462932e-08,  /* мл. ч. CBRT (1+26/32) */
    7.1665785964421199494e-07,  /* мл. ч. CBRT (1+27/32) */
    3.7768037176949580566e-07,  /* мл. ч. CBRT (1+28/32) */
    2.0715930567360205508e-07,  /* мл. ч. CBRT (1+29/32) */
    3.6653866541033171838e-07,  /* мл. ч. CBRT (1+30/32) */
    9.2874847037664090444e-07,  /* мл. ч. CBRT (1+31/32) */
    9.2965561535226721061e-07   /* мл. ч. CBRT (1+32/32) */
};

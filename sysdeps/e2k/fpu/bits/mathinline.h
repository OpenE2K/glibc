...
{
#pragma asm_inline
  __asm ("fscaled %0,%1,%0" : "+r" (__x) : "ri" (__n));
  return __x;
}
...
{
#pragma asm_inline
  __asm ("fscaled %0,%1,%0" : "+r" (__x) : "ri" (__exp));
  return __x;
}
...
__NTH (__scalbn (double __x, int __n))
{
  ...
  __xx.__i &= ~0x7ff0000000000000LL; /* zeroing the exponent */
  __k += __n;
  if (__k <= -54) {
...
__NTH (__scalbnf (float __x, int __n))
{
  ...
  if (__k == 0xff)
    return __x + __x;                                       /* NaN or Inf */
  __xx.__i &= ~0x7f800000;                          /* zeroing the exponent */
...
{
#pragma asm_inline
  __asm ("fscales %0,%1,%0" : "+r" (__x) : "ri" (__n));
  return __x;
}
...
__MATH_INLINE long double
__NTH (scalblnl (long double __x, long int __n))
{
#ifdef __ptr64__
  if (__n > 50000) __n = 50000;
...
__MATH_INLINE float
__NTH (fmaf (float __x, float __y, float __z))
{
  __extension__ union { float __f; unsigned int __i; } __xx = { __f: __x }, __yy = { __f: __y }, __zz = { __f: __z };
  __zz.__i = __builtin_e2k_fmas (__xx.__i, __yy.__i, __zz.__i);
  return __zz.__f;
}

__MATH_INLINE double
__NTH (fma (double __x, double __y, double __z))
{
  __extension__ union { double __f; long long __i; } __xx = { __f: __x }, __yy = { __f: __y }, __zz = { __f: __z };
  __zz.__i = __builtin_e2k_fmad (__xx.__i, __yy.__i, __zz.__i);
  return __zz.__f;
}
...
{
#pragma asm_inline
  __asm ("fscales %0,%1,%0" : "+r" (__x) : "ri" (__exp));
  return __x;
}

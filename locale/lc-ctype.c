...
pragma_no_asm_inline compat_symbol_reference (libc, __ctype_b, __ctype_b, GLIBC_2_0);
pragma_no_asm_inline compat_symbol_reference (libc, __ctype_tolower, __ctype_tolower, GLIBC_2_0);
pragma_no_asm_inline compat_symbol_reference (libc, __ctype_toupper, __ctype_toupper, GLIBC_2_0);
pragma_no_asm_inline compat_symbol_reference (libc, __ctype32_b, __ctype32_b, GLIBC_2_0);
pragma_no_asm_inline compat_symbol_reference (libc, __ctype32_tolower, __ctype32_tolower,
					      GLIBC_2_2);
pragma_no_asm_inline compat_symbol_reference (libc, __ctype32_toupper, __ctype32_toupper,
					      GLIBC_2_2);
